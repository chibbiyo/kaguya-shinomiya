...
export default class Command extends BaseCommand {
    constructor(client: WAClient, handler: MessageHandler) {
        ...
        console.log(chitoge)
        const { data } = await axios.get(`https://api-xcoders.xyz/api/download/ig?url=${chitoge}?igshid=${chitoge}&apikey=f8YZwl2SD9`)
